...
Color kRedColor = const Color(0xFFE53935);
Color kGreenColor = const Color(0xFF43A047);
Color kYellowColor = const Color(0xFFFFB300);
Color kPurpleColor = const Color(0xFF7E57C2);
Color kCyanColor = const Color(0xFF00ACC1);
